...
bool cdr_serialize_fast_lio__msg__Pose6D(
  const fast_lio__msg__Pose6D * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fast_lio
bool cdr_deserialize_fast_lio__msg__Pose6D(
  eprosima::fastcdr::Cdr & cdr,
  fast_lio__msg__Pose6D * ros_message)
{
  // Field name: offset_time
  {
    cdr >> ros_message->offset_time;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fast_lio__msg__Pose6D;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fast_lio
bool cdr_serialize_key_fast_lio__msg__Pose6D(
  const fast_lio__msg__Pose6D * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: offset_time
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fast_lio
size_t get_serialized_size_key_fast_lio__msg__Pose6D(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Pose6D__ros_msg_type * ros_message = static_cast<const _Pose6D__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fast_lio
size_t max_serialized_size_key_fast_lio__msg__Pose6D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const fast_lio__msg__Pose6D * ros_message = static_cast<const fast_lio__msg__Pose6D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_fast_lio__msg__Pose6D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  fast_lio__msg__Pose6D * ros_message = static_cast<fast_lio__msg__Pose6D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_fast_lio__msg__Pose6D(cdr, ros_message);
}
...
static size_t _Pose6D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fast_lio__msg__Pose6D(
